    ...
    return (
      <div className="grid place-items-center px-16">
        ...
        <div className="w-full max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-20 my-6">
                ...
                <form onSubmit={handleSubmit} onReset={handleReset} className="grid grid-cols-1 h-full border border-[#0E7488] p-6 gap-y-8 rounded-xl shadow-xl">
                    ...
                    <div className="flex items-center">
                        ...
                        <select 
                            ...
                            id="type"
                            onChange={handleChange}
                            className="h-10 flex-1 border border-[#0E7488] text-sm md:text-base rounded-md shadow-md px-3 text-[#222222] bg-[#d1dfdc] focus:outline-none focus:ring-2 focus:ring-[#0E7488] cursor-pointer hover:text-[#2B54A1]"
                        >
            ...
            <div className="grid grid-rows-[12fr_1fr] h-full max-h-256 border border-[#0E7488] rounded-xl shadow-xl">
                ...
                <button onClick={handleCopy} className="flex items-center justify-center gap-2 w-full bg-[#d1dfdc] rounded-xl shadow-xl cursor-pointer hover:text-[#2B54A1] hover:font-bold">
                    {isCopied ? (
                        <>
                            Copied! 
